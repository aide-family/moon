...
type Oss struct {
	...
	// 文件大小
	LimitSize map[string]*FileLimit `protobuf:"bytes,6,rep,name=limitSize,proto3" json:"limitSize,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// 是否打开oss
