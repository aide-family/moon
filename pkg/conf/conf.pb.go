...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x48, 0x0a, 0x02, 0x4d, 0x51, 0x12, 0x12, 0x0a, 0x04, 0x74,
	...
	0x6b, 0x65, 0x74, 0x4d, 0x51, 0x52, 0x08, 0x72, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x4d, 0x51, 0x42,
...
var file_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_conf_conf_proto_goTypes = []any{
	...
	(*MQ)(nil),                  // 31: pkg.conf.MQ
	nil,                         // 32: pkg.conf.Server.MetadataEntry
	(*ReceiverPhone_Call)(nil),  // 33: pkg.conf.ReceiverPhone.Call
	(*ReceiverPhone_Sms)(nil),   // 34: pkg.conf.ReceiverPhone.Sms
	nil,                         // 35: pkg.conf.Oss.LimitSizeEntry
	(*durationpb.Duration)(nil), // 36: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	32, // 0: pkg.conf.Server.metadata:type_name -> pkg.conf.Server.MetadataEntry
	36, // 1: pkg.conf.HTTPServer.timeout:type_name -> google.protobuf.Duration
	36, // 2: pkg.conf.GRPCServer.timeout:type_name -> google.protobuf.Duration
	36, // 3: pkg.conf.JWT.expire:type_name -> google.protobuf.Duration
	36, // 4: pkg.conf.Redis.read_timeout:type_name -> google.protobuf.Duration
	36, // 5: pkg.conf.Redis.write_timeout:type_name -> google.protobuf.Duration
	36, // 6: pkg.conf.Redis.dial_timeout:type_name -> google.protobuf.Duration
	...
	36, // 10: pkg.conf.MicroServer.timeout:type_name -> google.protobuf.Duration
	10, // 11: pkg.conf.Tracer.jaeger:type_name -> pkg.conf.Jaeger
	36, // 12: pkg.conf.ETCD.timeout:type_name -> google.protobuf.Duration
	...
	35, // 26: pkg.conf.Oss.limitSize:type_name -> pkg.conf.Oss.LimitSizeEntry
	30, // 27: pkg.conf.MQ.rocketMQ:type_name -> pkg.conf.RocketMQ
	28, // 28: pkg.conf.Oss.LimitSizeEntry.value:type_name -> pkg.conf.FileLimit
