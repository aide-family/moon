...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conf_conf_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
	...
	file_conf_conf_proto_msgTypes[0].OneofWrappers = []interface{}{}
