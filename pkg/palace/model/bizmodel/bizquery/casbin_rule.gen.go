...
func newCasbinRule(db *gorm.DB, opts ...gen.DOOption) casbinRule {
	...
	_casbinRule.casbinRuleDo.UseModel(&bizmodel.CasbinRule{})

	tableName := _casbinRule.casbinRuleDo.TableName()
	_casbinRule.ALL = field.NewAsterisk(tableName)
	_casbinRule.ID = field.NewUint32(tableName, "id")
...
type ICasbinRuleDo interface {
	...
	Create(values ...*bizmodel.CasbinRule) error
	CreateInBatches(values []*bizmodel.CasbinRule, batchSize int) error
	Save(values ...*bizmodel.CasbinRule) error
	First() (*bizmodel.CasbinRule, error)
	Take() (*bizmodel.CasbinRule, error)
	Last() (*bizmodel.CasbinRule, error)
	Find() ([]*bizmodel.CasbinRule, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*bizmodel.CasbinRule, err error)
	FindInBatches(result *[]*bizmodel.CasbinRule, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*bizmodel.CasbinRule) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*bizmodel.CasbinRule, error)
	FirstOrCreate() (*bizmodel.CasbinRule, error)
	FindByPage(offset int, limit int) (result []*bizmodel.CasbinRule, count int64, err error)
...
func (c casbinRuleDo) Create(values ...*bizmodel.CasbinRule) error {
	if len(values) == 0 {
		return nil
	}
...
func (c casbinRuleDo) CreateInBatches(values []*bizmodel.CasbinRule, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c casbinRuleDo) Save(values ...*bizmodel.CasbinRule) error {
	if len(values) == 0 {
		return nil
	}
...
func (c casbinRuleDo) First() (*bizmodel.CasbinRule, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*bizmodel.CasbinRule), nil
	}
}

func (c casbinRuleDo) Take() (*bizmodel.CasbinRule, error) {
...
func (c casbinRuleDo) Last() (*bizmodel.CasbinRule, error) {
...
func (c casbinRuleDo) Find() ([]*bizmodel.CasbinRule, error) {
	result, err := c.DO.Find()
	return result.([]*bizmodel.CasbinRule), err
}

func (c casbinRuleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*bizmodel.CasbinRule, err error) {
	buf := make([]*bizmodel.CasbinRule, 0, batchSize)
...
func (c casbinRuleDo) FindInBatches(result *[]*bizmodel.CasbinRule, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c casbinRuleDo) FirstOrInit() (*bizmodel.CasbinRule, error) {
...
func (c casbinRuleDo) FirstOrCreate() (*bizmodel.CasbinRule, error) {
...
func (c casbinRuleDo) FindByPage(offset int, limit int) (result []*bizmodel.CasbinRule, count int64, err error) {
...
func (c casbinRuleDo) Delete(models ...*bizmodel.CasbinRule) (result gen.ResultInfo, err error) {
