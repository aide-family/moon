...
// Create func
func (c *StrategyTemplate) Create(ctx context.Context, tx *gorm.DB) error {
	return tx.WithContext(ctx).Create(c).Error
}

// Update func
func (c *StrategyTemplate) Update(ctx context.Context, tx *gorm.DB, conds []gen.Condition) error {
	return tx.WithContext(ctx).Model(c).Where(conds).Updates(c).Error
}

// Delete func
func (c *StrategyTemplate) Delete(ctx context.Context, tx *gorm.DB, conds []gen.Condition) error {
