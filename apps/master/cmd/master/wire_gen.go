...
func wireApp(bootstrap *conf.Bootstrap, logger log.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, logger, tracerProvider, pingService, promV1Service)
	httpServer := server.NewHTTPServer(confServer, logger, tracerProvider, pingService, promV1Service)
