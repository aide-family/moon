...
func wireApp(bootstrap *conf.Bootstrap, logger log.Logger) (*kratos.App, func(), error) {
	...
	promRepo := data.NewPromRepo(dataData, logger)
	promLogic := biz.NewPromLogic(promRepo, logger)
	promService := service.NewPromService(promLogic, logger)
	grpcServer := server.NewGRPCServer(confServer, logger, tracerProvider, pingService, promService)
	httpServer := server.NewHTTPServer(confServer, logger, tracerProvider, pingService, promService)
