...
func NewPromService(logic IPromV1Logic, logger log.Logger) *PromV1Service {
	return &PromV1Service{logic: logic, logger: log.NewHelper(log.With(logger, "module", promModuleName))}
}

func (l *PromV1Service) CreateGroup(ctx context.Context, req *pb.CreateGroupRequest) (*pb.CreateGroupReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.CreateGroup")
	defer span.End()
...
func (l *PromV1Service) UpdateGroup(ctx context.Context, req *pb.UpdateGroupRequest) (*pb.UpdateGroupReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.UpdateGroup")
	defer span.End()
...
func (l *PromV1Service) UpdateGroupsStatus(ctx context.Context, request *pb.UpdateGroupsStatusRequest) (*pb.UpdateGroupsStatusReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.UpdateGroupStatus")
	defer span.End()
...
func (l *PromV1Service) DeleteGroup(ctx context.Context, req *pb.DeleteGroupRequest) (*pb.DeleteGroupReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.DeleteGroup")
	defer span.End()
...
func (l *PromV1Service) GetGroup(ctx context.Context, req *pb.GetGroupRequest) (*pb.GetGroupReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.GetGroup")
	defer span.End()
...
func (l *PromV1Service) CreateStrategy(ctx context.Context, req *pb.CreateStrategyRequest) (*pb.CreateStrategyReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.CreateStrategy")
	defer span.End()
...
func (l *PromV1Service) UpdateStrategy(ctx context.Context, req *pb.UpdateStrategyRequest) (*pb.UpdateStrategyReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.UpdateStrategy")
	defer span.End()
...
func (l *PromV1Service) UpdateStrategiesStatus(ctx context.Context, req *pb.UpdateStrategiesStatusRequest) (*pb.UpdateStrategiesStatusReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.UpdateStrategiesStatus")
	defer span.End()
...
func (l *PromV1Service) DeleteStrategy(ctx context.Context, req *pb.DeleteStrategyRequest) (*pb.DeleteStrategyReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.DeleteStrategy")
	defer span.End()
...
func (l *PromV1Service) GetStrategy(ctx context.Context, req *pb.GetStrategyRequest) (*pb.GetStrategyReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.GetStrategy")
	defer span.End()
...
func (l *PromV1Service) ListStrategy(ctx context.Context, req *pb.ListStrategyRequest) (*pb.ListStrategyReply, error) {
	ctx, span := otel.Tracer(promModuleName).Start(ctx, "PromV1Service.ListStrategy")
	defer span.End()
