...
func NewDictService(logic IDictV1Logic, logger log.Logger) *DictV1Service {
	return &DictV1Service{logic: logic, logger: log.NewHelper(log.With(logger, "module", dictModuleName))}
}

func (l *DictV1Service) CreateDict(ctx context.Context, req *pb.CreateDictRequest) (*pb.CreateDictReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.CreateDict")
	defer span.End()
...
func (l *DictV1Service) UpdateDict(ctx context.Context, req *pb.UpdateDictRequest) (*pb.UpdateDictReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.UpdateDict")
	defer span.End()
...
func (l *DictV1Service) UpdateDictsStatus(ctx context.Context, req *pb.UpdateDictsStatusRequest) (*pb.UpdateDictsStatusReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.UpdateDictsStatus")
	defer span.End()
...
func (l *DictV1Service) DeleteDict(ctx context.Context, req *pb.DeleteDictRequest) (*pb.DeleteDictReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.DeleteDict")
	defer span.End()
...
func (l *DictV1Service) GetDict(ctx context.Context, req *pb.GetDictRequest) (*pb.GetDictReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.GetDict")
	defer span.End()
...
func (l *DictV1Service) ListDict(ctx context.Context, req *pb.ListDictRequest) (*pb.ListDictReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.ListDict")
	defer span.End()
...
func (l *DictV1Service) Datasources(ctx context.Context, req *pb.DatasourcesRequest) (*pb.DatasourcesReply, error) {
	ctx, span := otel.Tracer(dictModuleName).Start(ctx, "DictV1Service.Datasources")
	defer span.End()
