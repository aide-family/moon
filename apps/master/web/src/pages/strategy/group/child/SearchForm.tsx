...
const SearchForm: React.FC<SearchFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      let formData = {
        ...
        time: [
          query?.query.startAt
            ? dayjs.unix(+query.query.startAt).format("YYYY-MM-DD HH:mm:ss")
            : "",
          query?.query.endAt
            ? dayjs.unix(+query.query.endAt).format("YYYY-MM-DD HH:mm:ss")
            : "",
        ],
  ...
  return (
    <div className={groupStyle.SearchFormDiv}>
      <Form
        form={form}
        layout="inline"
