...
func newNamespace(db *gorm.DB, opts ...gen.DOOption) namespace {
	...
	_namespace.namespaceDo.UseModel(&do.Namespace{})
...
func (n *namespace) fillFieldMap() {
	...
	n.fieldMap["logo"] = n.Logo
	n.fieldMap["secret"] = n.Secret
	n.fieldMap["banners"] = n.Banners
	n.fieldMap["remark"] = n.Remark
	n.fieldMap["leader"] = n.Leader
}
...
type INamespaceDo interface {
	...
	Create(values ...*do.Namespace) error
	CreateInBatches(values []*do.Namespace, batchSize int) error
	Save(values ...*do.Namespace) error
	First() (*do.Namespace, error)
	Take() (*do.Namespace, error)
	Last() (*do.Namespace, error)
	Find() ([]*do.Namespace, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do.Namespace, err error)
	FindInBatches(result *[]*do.Namespace, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*do.Namespace) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*do.Namespace, error)
	FirstOrCreate() (*do.Namespace, error)
	FindByPage(offset int, limit int) (result []*do.Namespace, count int64, err error)
...
func (n namespaceDo) Create(values ...*do.Namespace) error {
	if len(values) == 0 {
		return nil
	}
...
func (n namespaceDo) CreateInBatches(values []*do.Namespace, batchSize int) error {
	return n.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (n namespaceDo) Save(values ...*do.Namespace) error {
	if len(values) == 0 {
		return nil
	}
...
func (n namespaceDo) First() (*do.Namespace, error) {
	if result, err := n.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do.Namespace), nil
	}
}

func (n namespaceDo) Take() (*do.Namespace, error) {
...
func (n namespaceDo) Last() (*do.Namespace, error) {
...
func (n namespaceDo) Find() ([]*do.Namespace, error) {
	result, err := n.DO.Find()
	return result.([]*do.Namespace), err
}

func (n namespaceDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do.Namespace, err error) {
	buf := make([]*do.Namespace, 0, batchSize)
...
func (n namespaceDo) FindInBatches(result *[]*do.Namespace, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (n namespaceDo) FirstOrInit() (*do.Namespace, error) {
...
func (n namespaceDo) FirstOrCreate() (*do.Namespace, error) {
...
func (n namespaceDo) FindByPage(offset int, limit int) (result []*do.Namespace, count int64, err error) {
...
func (n namespaceDo) Delete(models ...*do.Namespace) (result gen.ResultInfo, err error) {
