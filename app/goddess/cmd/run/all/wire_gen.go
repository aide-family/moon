...
func WireApp(serviceName string, bc *conf.Bootstrap, helper *log.Helper) ([]*kratos.App, func(), error) {
	...
	servers := server.RegisterService(bc, httpServer, grpcServer, authService, healthService, namespaceService, userService, memberService, selfService, captchaService)
