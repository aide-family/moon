...
func WireApp(serviceName string, bc *conf.Bootstrap, helper *log.Helper) ([]*kratos.App, func(), error) {
	...
	servers := server.RegisterHTTPService(bc, httpServer, authService, healthService, namespaceService, selfService, userService, memberService, captchaService, emailService, webhookService, senderService, templateService, messageLogService, recipientGroupService)
