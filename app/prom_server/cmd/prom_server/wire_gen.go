...
func wireApp(string2 *string) (*kratos.App, func(), error) {
	...
	strategyBiz := biz.NewStrategyBiz(strategyRepo, notifyRepo, logger)
	...
	alarmPageBiz := biz.NewPageBiz(pageRepo, alarmRealtimeRepo, logger)
	...
	historyBiz := biz.NewHistoryBiz(historyRepo, msgRepo, strategyRepo, alarmRealtimeBiz, logger)
