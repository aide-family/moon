...
func wireApp(string2 *string) (*kratos.App, func(), error) {
	...
	sysDictRepo := promdict.NewSysDictRepo(dataData, logger)
	sysDictBiz := biz.NewSysDictBiz(sysDictRepo, logger)
	...
	systemserviceService := systemservice.NewDictService(sysDictBiz, alarmPageBiz, logger)
