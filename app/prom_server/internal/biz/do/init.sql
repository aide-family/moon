...
INSERT INTO `prom_alarm_pages` (id, name, remark, icon, color)
VALUES (1, '实时告警', '实时告警', 'el-icon-bell', '#f56c6c'),
       (2, '我的告警', '我的告警', 'el-icon-document', '#409EFF'),
       (3, '测试告警', '测试告警', 'el-icon-data-line', '#67C23A');

INSERT INTO `prom_dict` (id, name, category, remark, color)
VALUES (1, '一级优先级', 5, '告警级别', '#a8071a'),
       (2, '二级优先级', 5, '告警级别', '#ad2102'),
       (3, '三级优先级', 5, '告警级别', '#ad4e00'),
       (4, '四级优先级', 5, '告警级别', '#ad6800'),
       (5, '五级优先级', 5, '告警级别', '#ad8b00'),
       (6, '六级优先级', 5, '告警级别', '#5b8c00'),
       (7, '系统策略', 3, '策略类型', '#409EFF'),
       (8, '系统策略组', 4, '系统策略组', '#409EFF');