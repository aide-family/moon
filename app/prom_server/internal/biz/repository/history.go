...
type (
	...
	HistoryRepo interface {
		...
		// CreateHistory 创建历史
		CreateHistory(ctx context.Context, historyBO ...*bo.AlarmHistoryBO) ([]*bo.AlarmHistoryBO, error)
...
func (UnimplementedHistoryRepo) CreateHistory(_ context.Context, _ ...*bo.AlarmHistoryBO) ([]*bo.AlarmHistoryBO, error) {
