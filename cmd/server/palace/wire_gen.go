...
func wireApp(bootstrap *palaceconf.Bootstrap, logger log.Logger) (*kratos.App, func(), error) {
	...
	authorizationBiz := biz.NewAuthorizationBiz(userRepo, teamRepo, cacheRepo, teamRoleRepo)
	...
	teamMenuRepo := repoimpl.NewTeamMenuRepo(dataData)
	menuBiz := biz.NewMenuBiz(teamMenuRepo)
