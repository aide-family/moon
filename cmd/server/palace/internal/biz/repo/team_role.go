...
type TeamRoleRepo interface {
	...
	CreateTeamRole(ctx context.Context, teamRole *bo.CreateTeamRoleParams) (*model.SysTeamRole, error)
	...
	// GetTeamRole 获取团队角色
	GetTeamRole(ctx context.Context, id uint32) (*model.SysTeamRole, error)

	// ListTeamRole 获取团队角色列表
	ListTeamRole(ctx context.Context, params *bo.ListTeamRoleParams) ([]*model.SysTeamRole, error)

	// GetTeamRoleByUserID 获取用户团队角色
	GetTeamRoleByUserID(ctx context.Context, userID, teamID uint32) ([]*model.SysTeamRole, error)
