...
type (
	...
	AlarmGroup interface {
		...
		CreateAlarmGroup(context.Context, *bo.CreateAlarmGroupParams) (*bizmodel.AlarmNoticeGroup, error)
		...
		// AlarmGroupPage 告警列表
		AlarmGroupPage(context.Context, *bo.QueryAlarmGroupListParams) ([]*bizmodel.AlarmNoticeGroup, error)
		// UpdateStatus 更新状态
