...
type SysAPI struct {
	...
	Name      string      `gorm:"column:name;type:varchar(64);not null;uniqueIndex:idx__name,priority:1;uniqueIndex:idx__sa__name,priority:1;comment:api名称" json:"name"`  // api名称
	Path      string      `gorm:"column:path;type:varchar(255);not null;uniqueIndex:idx__path,priority:1;uniqueIndex:idx__sa__path,priority:1;comment:api路径" json:"path"` // api路径
