...
func (s *Service) CreateStrategyGroup(ctx context.Context, req *strategyapi.CreateStrategyGroupRequest) (*strategyapi.CreateStrategyGroupReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithCreateStrategyGroupRequest(req).ToBo()
...
func (s *Service) DeleteStrategyGroup(ctx context.Context, req *strategyapi.DeleteStrategyGroupRequest) (*strategyapi.DeleteStrategyGroupReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithDeleteStrategyGroupRequest(req).ToBo()
...
func (s *Service) ListStrategyGroup(ctx context.Context, req *strategyapi.ListStrategyGroupRequest) (*strategyapi.ListStrategyGroupReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithListStrategyGroupRequest(req).ToBo()
	...
	return &strategyapi.ListStrategyGroupReply{
		...
		List:       builder.NewParamsBuild(ctx).StrategyModuleBuilder().DoStrategyGroupBuilder().WithStrategyCountMap(countDetail).ToAPIs(listPage),
	}, nil
}
...
func (s *Service) GetStrategyGroup(ctx context.Context, req *strategyapi.GetStrategyGroupRequest) (*strategyapi.GetStrategyGroupReply, error) {
	...
	return &strategyapi.GetStrategyGroupReply{
		Detail: builder.NewParamsBuild(ctx).StrategyModuleBuilder().DoStrategyGroupBuilder().WithStrategyCountMap(countDetail).ToAPI(groupDetail),
	}, nil
}
...
func (s *Service) UpdateStrategyGroup(ctx context.Context, req *strategyapi.UpdateStrategyGroupRequest) (*strategyapi.UpdateStrategyGroupReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithUpdateStrategyGroupRequest(req).ToBo()
...
func (s *Service) UpdateStrategyGroupStatus(ctx context.Context, req *strategyapi.UpdateStrategyGroupStatusRequest) (*strategyapi.UpdateStrategyGroupStatusReply, error) {
	param := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithUpdateStrategyGroupStatusRequest(req).ToBo()
...
func checkStrategyLevelIsDuplicates(req *strategyapi.CreateStrategyRequest) bool {
	...
	case vobj.StrategyTypeMetric:
		return types.SlicesHasDuplicates(req.GetStrategyMetricLevels(), func(request *strategyapi.CreateStrategyMetricLevelRequest) string {
...
func (s *Service) ListStrategy(ctx context.Context, req *strategyapi.ListStrategyRequest) (*strategyapi.ListStrategyReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithListStrategyRequest(req).ToBo()
	...
	return &strategyapi.ListStrategyReply{
		Pagination: builder.NewParamsBuild(ctx).PaginationModuleBuilder().ToAPI(params.Page),
		List:       builder.NewParamsBuild(ctx).StrategyModuleBuilder().DoStrategyBuilder().ToAPIs(strategies),
	}, nil
}
...
func (s *Service) UpdateStrategyStatus(ctx context.Context, req *strategyapi.UpdateStrategyStatusRequest) (*strategyapi.UpdateStrategyStatusReply, error) {
	params := builder.NewParamsBuild(ctx).StrategyModuleBuilder().WithUpdateStrategyStatusRequest(req).ToBo()
