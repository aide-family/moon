...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.PromAlarmPage.UnderlyingDB().Statement.Context,
		qCtx.PromDict.UnderlyingDB().Statement.Context,
		qCtx.PromGroup.UnderlyingDB().Statement.Context,
		qCtx.PromStrategy.UnderlyingDB().Statement.Context,
	} {
