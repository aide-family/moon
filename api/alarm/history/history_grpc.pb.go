...
const (
	History_GetHistory_FullMethodName  = "/api.alarm.history.History/GetHistory"
	History_ListHistory_FullMethodName = "/api.alarm.history.History/ListHistory"
)
...
func (c *historyClient) GetHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*GetHistoryReply, error) {
	...
	err := c.cc.Invoke(ctx, History_GetHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *historyClient) ListHistory(ctx context.Context, in *ListHistoryRequest, opts ...grpc.CallOption) (*ListHistoryReply, error) {
	...
	err := c.cc.Invoke(ctx, History_ListHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _History_GetHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: History_GetHistory_FullMethodName,
	}
...
var History_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.alarm.history.History",
	...
	Metadata: "alarm/history/history.proto",
}
