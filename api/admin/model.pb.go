...
type StrategyLevel struct {
	...
	// 持续的类型
	SustainType api.SustainType `protobuf:"varint,5,opt,name=sustainType,proto3,enum=api.SustainType" json:"sustainType,omitempty"`
	// 策略标签
	...
	// 状态
	Status api.Status `protobuf:"varint,9,opt,name=status,proto3,enum=api.Status" json:"status,omitempty"`
	// 数据主键
	Id uint32 `protobuf:"varint,10,opt,name=id,proto3" json:"id,omitempty"`
	// 告警等级ID
	LevelId uint32 `protobuf:"varint,11,opt,name=level_id,json=levelId,proto3" json:"level_id,omitempty"`
	// 告警等级明细
	Level *Select `protobuf:"bytes,12,opt,name=level,proto3" json:"level,omitempty"`
	// 告警页面
	AlarmPages []*Select `protobuf:"bytes,13,rep,name=alarmPages,proto3" json:"alarmPages,omitempty"`
	// 阈值
	Threshold float64 `protobuf:"fixed64,14,opt,name=threshold,proto3" json:"threshold,omitempty"`
	// 所属策略
	StrategyId uint32 `protobuf:"varint,15,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	// 条件
	Condition string `protobuf:"bytes,16,opt,name=condition,proto3" json:"condition,omitempty"` // TODO 通知对象
}

func (x *StrategyLevel) Reset() {
	*x = StrategyLevel{}
	if protoimpl.UnsafeEnabled {
...
func (x *StrategyLevel) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StrategyLevel) ProtoMessage() {}

func (x *StrategyLevel) ProtoReflect() protoreflect.Message {
	mi := &file_admin_model_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StrategyLevel.ProtoReflect.Descriptor instead.
func (*StrategyLevel) Descriptor() ([]byte, []int) {
	return file_admin_model_proto_rawDescGZIP(), []int{12}
}

func (x *StrategyLevel) GetFor() *durationpb.Duration {
	if x != nil {
		return x.For
	}
	return nil
...
func (x *StrategyLevel) GetCount() uint32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *StrategyLevel) GetSustainType() api.SustainType {
	if x != nil {
		return x.SustainType
	}
	return api.SustainType(0)
}

func (x *StrategyLevel) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *StrategyLevel) GetAnnotations() map[string]string {
	if x != nil {
...
func (x *StrategyLevel) GetInterval() *durationpb.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
func (x *StrategyLevel) GetStatus() api.Status {
	if x != nil {
		return x.Status
	}
	return api.Status(0)
...
func (x *StrategyLevel) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *StrategyLevel) GetLevelId() uint32 {
	if x != nil {
		return x.LevelId
	}
	return 0
...
func (x *StrategyLevel) GetLevel() *Select {
	if x != nil {
		return x.Level
	}
	return nil
...
func (x *StrategyLevel) GetAlarmPages() []*Select {
	if x != nil {
		return x.AlarmPages
	}
	return nil
...
func (x *StrategyLevel) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *StrategyLevel) GetStrategyId() uint32 {
	if x != nil {
		return x.StrategyId
	}
	return 0
...
func (x *StrategyLevel) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
type Strategy struct {
	...
	Level map[uint32]*StrategyLevel `protobuf:"bytes,3,rep,name=level,proto3" json:"level,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// 数据源
	Datasource []*Datasource `protobuf:"bytes,9,rep,name=datasource,proto3" json:"datasource,omitempty"`
	// 策略ID
	Id uint32 `protobuf:"varint,10,opt,name=id,proto3" json:"id,omitempty"`
	// 策略状态
	Status api.Status `protobuf:"varint,11,opt,name=status,proto3,enum=api.Status" json:"status,omitempty"`
	// 创建时间
	...
	// 策略组信息
	Group *StrategyGroup `protobuf:"bytes,16,opt,name=group,proto3" json:"group,omitempty"`
	// 告警页面
	AlarmPages []*Select `protobuf:"bytes,17,rep,name=alarmPages,proto3" json:"alarmPages,omitempty"` // TODO 公共通知对象
}

func (x *Strategy) Reset() {
	*x = Strategy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_admin_model_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Strategy) Descriptor() ([]byte, []int) {
	return file_admin_model_proto_rawDescGZIP(), []int{13}
}
...
func (x *Strategy) GetLevel() map[uint32]*StrategyLevel {
	if x != nil {
		return x.Level
	}
	return nil
...
func (x *Strategy) GetStatus() api.Status {
	if x != nil {
		return x.Status
	}
	return api.Status(0)
...
func (x *Strategy) GetGroupId() uint32 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *Strategy) GetGroup() *StrategyGroup {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *Strategy) GetAlarmPages() []*Select {
	if x != nil {
		return x.AlarmPages
	}
	return nil
...
func (x *StrategyGroup) Reset() {
	*x = StrategyGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_admin_model_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StrategyGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StrategyGroup) ProtoMessage() {}

func (x *StrategyGroup) ProtoReflect() protoreflect.Message {
	mi := &file_admin_model_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StrategyGroup.ProtoReflect.Descriptor instead.
func (*StrategyGroup) Descriptor() ([]byte, []int) {
	return file_admin_model_proto_rawDescGZIP(), []int{14}
}

func (x *StrategyGroup) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *StrategyGroup) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StrategyGroup) GetStatus() api.Status {
	if x != nil {
		return x.Status
	}
	return api.Status(0)
...
func (x *StrategyGroup) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *StrategyGroup) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
func (x *StrategyGroup) GetRemark() string {
	if x != nil {
		return x.Remark
	}
	return ""
...
func (x *StrategyGroup) GetCreator() *User {
	if x != nil {
		return x.Creator
	}
	return nil
...
func (x *StrategyGroup) GetCreatorId() uint32 {
	if x != nil {
		return x.CreatorId
	}
	return 0
...
var file_admin_model_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x09, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x1a, 0x1e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f,
	0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e,
	0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xcc, 0x05, 0x0a,
	0x0d, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x2b,
	...
	,
	...
	,
	...
	0x23, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x12, 0x29, 0x0a,
	0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f,
	...
	0x74, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x42, 0x3a, 0x0a, 0x09, 0x61, 0x70, 0x69, 0x2e, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x50, 0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x61, 0x69, 0x64, 0x65, 0x2d, 0x66, 0x61, 0x6d, 0x69, 0x6c, 0x79, 0x2f, 0x6d,
	0x6f, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x3b, 0x61, 0x64,
...
var file_admin_model_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_admin_model_proto_goTypes = []interface{}{
	...
	(*StrategyLevel)(nil),       // 12: api.admin.StrategyLevel
	(*Strategy)(nil),            // 13: api.admin.Strategy
	(*StrategyGroup)(nil),       // 14: api.admin.StrategyGroup
	nil,                         // 15: api.admin.Datasource.ConfigEntry
	nil,                         // 16: api.admin.StrategyLevel.LabelsEntry
	nil,                         // 17: api.admin.StrategyLevel.AnnotationsEntry
	nil,                         // 18: api.admin.Strategy.LevelEntry
	(api.Status)(0),             // 19: api.Status
	(api.Gender)(0),             // 20: api.Gender
	(api.Role)(0),               // 21: api.Role
	(api.ModuleType)(0),         // 22: api.ModuleType
	(api.DomainType)(0),         // 23: api.DomainType
	(api.DatasourceType)(0),     // 24: api.DatasourceType
	(api.StorageType)(0),        // 25: api.StorageType
	(api.MetricType)(0),         // 26: api.MetricType
	(*durationpb.Duration)(nil), // 27: google.protobuf.Duration
	(api.SustainType)(0),        // 28: api.SustainType
}
var file_admin_model_proto_depIdxs = []int32{
	...
	19, // 2: api.admin.User.status:type_name -> api.Status
	20, // 3: api.admin.User.gender:type_name -> api.Gender
	21, // 4: api.admin.User.role:type_name -> api.Role
	19, // 5: api.admin.ResourceItem.status:type_name -> api.Status
	22, // 6: api.admin.ResourceItem.module:type_name -> api.ModuleType
	23, // 7: api.admin.ResourceItem.domain:type_name -> api.DomainType
	19, // 8: api.admin.Menu.status:type_name -> api.Status
	4,  // 9: api.admin.Menu.children:type_name -> api.admin.Menu
	21, // 10: api.admin.TeamMember.role:type_name -> api.Role
	19, // 11: api.admin.TeamMember.status:type_name -> api.Status
	2,  // 12: api.admin.TeamMember.user:type_name -> api.admin.User
	19, // 13: api.admin.Team.status:type_name -> api.Status
	...
	19, // 17: api.admin.TeamRole.status:type_name -> api.Status
	3,  // 18: api.admin.TeamRole.resources:type_name -> api.admin.ResourceItem
	24, // 19: api.admin.Datasource.type:type_name -> api.DatasourceType
	19, // 20: api.admin.Datasource.status:type_name -> api.Status
	15, // 21: api.admin.Datasource.config:type_name -> api.admin.Datasource.ConfigEntry
	25, // 22: api.admin.Datasource.storage_type:type_name -> api.StorageType
	26, // 23: api.admin.MetricDetail.type:type_name -> api.MetricType
	...
	27, // 26: api.admin.StrategyLevel.for:type_name -> google.protobuf.Duration
	28, // 27: api.admin.StrategyLevel.sustainType:type_name -> api.SustainType
	16, // 28: api.admin.StrategyLevel.labels:type_name -> api.admin.StrategyLevel.LabelsEntry
	17, // 29: api.admin.StrategyLevel.annotations:type_name -> api.admin.StrategyLevel.AnnotationsEntry
	27, // 30: api.admin.StrategyLevel.interval:type_name -> google.protobuf.Duration
	19, // 31: api.admin.StrategyLevel.status:type_name -> api.Status
	1,  // 32: api.admin.StrategyLevel.level:type_name -> api.admin.Select
	1,  // 33: api.admin.StrategyLevel.alarmPages:type_name -> api.admin.Select
	18, // 34: api.admin.Strategy.level:type_name -> api.admin.Strategy.LevelEntry
	8,  // 35: api.admin.Strategy.datasource:type_name -> api.admin.Datasource
	19, // 36: api.admin.Strategy.status:type_name -> api.Status
	14, // 37: api.admin.Strategy.group:type_name -> api.admin.StrategyGroup
	1,  // 38: api.admin.Strategy.alarmPages:type_name -> api.admin.Select
	19, // 39: api.admin.StrategyGroup.status:type_name -> api.Status
	2,  // 40: api.admin.StrategyGroup.creator:type_name -> api.admin.User
	12, // 41: api.admin.Strategy.LevelEntry.value:type_name -> api.admin.StrategyLevel
...
func file_admin_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_admin_model_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StrategyLevel); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_model_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_admin_model_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StrategyGroup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
