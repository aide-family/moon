...
const (
	Resource_GetResource_FullMethodName               = "/api.admin.resource.Resource/GetResource"
	Resource_ListResource_FullMethodName              = "/api.admin.resource.Resource/ListResource"
	Resource_BatchUpdateResourceStatus_FullMethodName = "/api.admin.resource.Resource/BatchUpdateResourceStatus"
	Resource_GetResourceSelectList_FullMethodName     = "/api.admin.resource.Resource/GetResourceSelectList"
)
...
func (c *resourceClient) BatchUpdateResourceStatus(ctx context.Context, in *BatchUpdateResourceStatusRequest, opts ...grpc.CallOption) (*BatchUpdateResourceStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, Resource_BatchUpdateResourceStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) GetResourceSelectList(ctx context.Context, in *GetResourceSelectListRequest, opts ...grpc.CallOption) (*GetResourceSelectListReply, error) {
	...
	err := c.cc.Invoke(ctx, Resource_GetResourceSelectList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Resource_BatchUpdateResourceStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Resource_BatchUpdateResourceStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Resource_GetResourceSelectList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Resource_GetResourceSelectList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
