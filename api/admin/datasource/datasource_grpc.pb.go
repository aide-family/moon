...
func (c *datasourceClient) SyncDatasourceMeta(ctx context.Context, in *SyncDatasourceMetaRequest, opts ...grpc.CallOption) (*SyncDatasourceMetaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.admin.datasource.Datasource/SyncDatasourceMeta", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *datasourceClient) DatasourceQuery(ctx context.Context, in *DatasourceQueryRequest, opts ...grpc.CallOption) (*DatasourceQueryReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.admin.datasource.Datasource/DatasourceQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Datasource_SyncDatasourceMeta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.admin.datasource.Datasource/SyncDatasourceMeta",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Datasource_DatasourceQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.admin.datasource.Datasource/DatasourceQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
