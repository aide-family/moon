...
var file_metadata_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x2b, 0x0a,
...
var file_metadata_proto_goTypes = []interface{}{
	...
	nil,                       // 2: api.MetricDetail.LabelsEntry
}
var file_metadata_proto_depIdxs = []int32{
	2, // 0: api.MetricDetail.labels:type_name -> api.MetricDetail.LabelsEntry
	0, // 1: api.MetricDetail.LabelsEntry.value:type_name -> api.MetricLabelValues
