...
func (x *EvaluateV2Request) Reset() {
	*x = EvaluateV2Request{}
	if protoimpl.UnsafeEnabled {
...
func (x *EvaluateV2Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EvaluateV2Request) ProtoMessage() {}

func (x *EvaluateV2Request) ProtoReflect() protoreflect.Message {
	mi := &file_agent_load_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EvaluateV2Request.ProtoReflect.Descriptor instead.
func (*EvaluateV2Request) Descriptor() ([]byte, []int) {
	return file_agent_load_proto_rawDescGZIP(), []int{6}
}

func (x *EvaluateV2Request) GetGroupList() []*api.EvaluateGroup {
	if x != nil {
		return x.GroupList
	}
	return nil
...
func (x *EvaluateV2Reply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EvaluateV2Reply) ProtoMessage() {}

func (x *EvaluateV2Reply) ProtoReflect() protoreflect.Message {
	mi := &file_agent_load_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EvaluateV2Reply.ProtoReflect.Descriptor instead.
func (*EvaluateV2Reply) Descriptor() ([]byte, []int) {
	return file_agent_load_proto_rawDescGZIP(), []int{7}
}

func (x *EvaluateV2Reply) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *EvaluateV2Reply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_agent_load_proto_rawDesc = []byte{
	...
	,
...
var file_agent_load_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_agent_load_proto_goTypes = []interface{}{
	...
	(*EvaluateV2Request)(nil),        // 6: api.agent.EvaluateV2Request
	(*EvaluateV2Reply)(nil),          // 7: api.agent.EvaluateV2Reply
	(*api.GroupSimple)(nil),          // 8: api.GroupSimple
	(*api.EvaluateGroup)(nil),        // 9: api.EvaluateGroup
}
var file_agent_load_proto_depIdxs = []int32{
	8, // 0: api.agent.StrategyGroupAllReply.groupList:type_name -> api.GroupSimple
	8, // 1: api.agent.StrategyGroupDiffReply.appendItems:type_name -> api.GroupSimple
	8, // 2: api.agent.StrategyGroupDiffReply.deleteItems:type_name -> api.GroupSimple
	8, // 3: api.agent.StrategyGroupDiffReply.updateItems:type_name -> api.GroupSimple
	8, // 4: api.agent.EvaluateRequest.groupList:type_name -> api.GroupSimple
	9, // 5: api.agent.EvaluateV2Request.groupList:type_name -> api.EvaluateGroup
	4, // 6: api.agent.Load.Evaluate:input_type -> api.agent.EvaluateRequest
	6, // 7: api.agent.Load.EvaluateV2:input_type -> api.agent.EvaluateV2Request
	5, // 8: api.agent.Load.Evaluate:output_type -> api.agent.EvaluateReply
	7, // 9: api.agent.Load.EvaluateV2:output_type -> api.agent.EvaluateV2Reply
...
func file_agent_load_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_load_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EvaluateV2Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
