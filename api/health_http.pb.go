...
const OperationHealthCheck = "/api.Health/Check"
...
func (c *HealthHTTPClientImpl) Check(ctx context.Context, in *CheckRequest, opts ...http.CallOption) (*CheckReply, error) {
	var out CheckReply
	pattern := "/health"
