...
const (
	// 自定义通知模板
	NotifyTemplateType_NotifyTemplateTypeCustom NotifyTemplateType = 0
	// 邮件通知模板
	NotifyTemplateType_NotifyTemplateTypeEmail NotifyTemplateType = 1
	// 短信通知模板
	NotifyTemplateType_NotifyTemplateTypeSms NotifyTemplateType = 2
	// 企业微信通知模板
	NotifyTemplateType_NotifyTemplateTypeWeChatWork NotifyTemplateType = 3
	// 飞书通知模板
	NotifyTemplateType_NotifyTemplateTypeFeiShu NotifyTemplateType = 4
	// 钉钉通知模板
	NotifyTemplateType_NotifyTemplateTypeDingDing NotifyTemplateType = 5
)

// Enum value maps for NotifyTemplateType.
var (
	NotifyTemplateType_name = map[int32]string{
		0: "NotifyTemplateTypeCustom",
		1: "NotifyTemplateTypeEmail",
		2: "NotifyTemplateTypeSms",
		3: "NotifyTemplateTypeWeChatWork",
		4: "NotifyTemplateTypeFeiShu",
		5: "NotifyTemplateTypeDingDing",
	}
	NotifyTemplateType_value = map[string]int32{
...
type PromStrategyV1 struct {
	...
	// 告警页面信息
	AlarmPageInfo []*DictSelectV1 `protobuf:"bytes,13,rep,name=alarmPageInfo,proto3" json:"alarmPageInfo,omitempty"`
	// 分类ID列表
...
type PrometheusServerItem struct {
	...
	UpdatedAt int64 `protobuf:"varint,7,opt,name=updatedAt,proto3" json:"updatedAt,omitempty"`
	// 数据源类型
	DatasourceType int32 `protobuf:"varint,8,opt,name=datasourceType,proto3" json:"datasourceType,omitempty"`
}
...
type ChatGroup struct {
	...
	// 创建者
	CreateUser *UserSelectV1 `protobuf:"bytes,13,opt,name=createUser,proto3" json:"createUser,omitempty"`
}
...
type BeNotifyMember struct {
	...
	// 通知方式, 可以同时多种类型
	NotifyType NotifyType `protobuf:"varint,2,opt,name=notifyType,proto3,enum=api.NotifyType" json:"notifyType,omitempty"`
	// 数据ID
...
type BeNotifyMemberDetail struct {
	...
	MemberId uint32 `protobuf:"varint,1,opt,name=memberId,proto3" json:"memberId,omitempty"`
	// 通知方式, 可以同时多种类型
	NotifyType int32 `protobuf:"varint,2,opt,name=notifyType,proto3" json:"notifyType,omitempty"`
	// 通知人明细
...
type StrategySimple struct {
	...
	// 基础认证字符串
	BasicAuth string `protobuf:"bytes,10,opt,name=basicAuth,proto3" json:"basicAuth,omitempty"`
}
...
type StrategyDatasource struct {
	...
	// 基础认证字符串
	BasicAuth string `protobuf:"bytes,2,opt,name=basicAuth,proto3" json:"basicAuth,omitempty"`
	// 数据源类型
	DatasourceType int32 `protobuf:"varint,3,opt,name=datasourceType,proto3" json:"datasourceType,omitempty"`
}

func (x *StrategyDatasource) Reset() {
	*x = StrategyDatasource{}
	if protoimpl.UnsafeEnabled {
...
type EvaluateStrategyItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// 注解
	Annotations map[string]string   `protobuf:"bytes,6,rep,name=annotations,proto3" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Datasource  *StrategyDatasource `protobuf:"bytes,7,opt,name=datasource,proto3" json:"datasource,omitempty"`
}

func (x *EvaluateStrategyItem) Reset() {
	*x = EvaluateStrategyItem{}
	if protoimpl.UnsafeEnabled {
...
type EvaluateGroup struct {
	...
	// 策略组名称
	Name       string                  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Strategies []*EvaluateStrategyItem `protobuf:"bytes,3,rep,name=strategies,proto3" json:"strategies,omitempty"`
}
...
type MyChart struct {
	...
	Status int32  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`
	// 图表类型
	ChartType ChartType `protobuf:"varint,6,opt,name=chartType,proto3,enum=api.ChartType" json:"chartType,omitempty"`
	// 宽度
...
func (x *MyChart) GetChartType() ChartType {
	if x != nil {
		return x.ChartType
	}
	return ChartType_CHART_TYPE_UNKNOWN
}

func (x *MyChart) GetWidth() string {
	if x != nil {
		return x.Width
	}
	return ""
...
func (x *MyChart) GetHeight() string {
	if x != nil {
		return x.Height
	}
	return ""
...
type NotifyTemplateItem struct {
	...
	// 模板类型
	NotifyType int32 `protobuf:"varint,4,opt,name=notifyType,proto3" json:"notifyType,omitempty"`
}

func (x *NotifyTemplateItem) Reset() {
	*x = NotifyTemplateItem{}
	if protoimpl.UnsafeEnabled {
...
var file_model_proto_rawDesc = []byte{
	...
	,
	...
	0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x6c, 0x61, 0x72, 0x6d, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x56, 0x31, 0x2e, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	...
	0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x41, 0x74,
	0x12, 0x14, 0x0a, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x78, 0x70, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x65, 0x78, 0x70, 0x72, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x61, 0x74, 0x61,
	...
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xe8, 0x01, 0x0a, 0x06, 0x44, 0x69, 0x63, 0x74, 0x56, 0x31, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x03, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xd6, 0x01, 0x0a,
	0x0c, 0x44, 0x69, 0x63, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x56, 0x31, 0x12, 0x14, 0x0a,
	...
	,
	...
	0x61, 0x70, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0x89, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x6d, 0x53, 0x74, 0x72, 0x61,
	0x74, 0x65, 0x67, 0x79, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x56, 0x31, 0x12, 0x14, 0x0a, 0x05,
	...
	0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x2d, 0x0a, 0x08, 0x63, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x44, 0x69, 0x63, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x56, 0x31, 0x52, 0x08, 0x63,
	...
	0xf9, 0x02, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x6d, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x0e, 0x0a,
	...
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x69, 0x63, 0x74,
	0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x56, 0x31, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x69, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04,
	...
	,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x2d, 0x0a,
	0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x11, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x69, 0x63, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x56, 0x31, 0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x16, 0x0a, 0x06,
	...
	,
	...
	0x52, 0x4c, 0x12, 0x20, 0x0a, 0x0b, 0x66, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70, 0x72, 0x69, 0x6e,
	0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x66, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70,
	0x72, 0x69, 0x6e, 0x74, 0x1a, 0x39, 0x0a, 0x0b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e,
	...
	0xea, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x53, 0x65,
	...
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x26, 0x0a, 0x0e, 0x64, 0x61, 0x74, 0x61, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x64, 0x61,
	0x74, 0x61, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x94, 0x01, 0x0a,
	0x1a, 0x50, 0x72, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x14, 0x0a, 0x05, 0x76,
	...
	0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x22, 0xa8, 0x02, 0x0a, 0x09, 0x43, 0x68, 0x61, 0x74, 0x47, 0x72, 0x6f, 0x75,
	...
	,
	...
	0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x76, 0x0a, 0x0e, 0x42, 0x65, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x08, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x42, 0x07, 0xfa,
	0x42, 0x04, 0x2a, 0x02, 0x20, 0x00, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64,
	0x12, 0x2f, 0x0a, 0x0a, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x54, 0x79, 0x70, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	...
	,
	...
	,
	...
	0x28, 0x03, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x46, 0x0a,
	0x12, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x4f,
	0x62, 0x6a, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x4f, 0x62,
	0x6a, 0x52, 0x12, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x79, 0x4f, 0x62, 0x6a, 0x73, 0x22, 0xe3, 0x02, 0x0a, 0x11, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x4f, 0x62, 0x6a, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	,
	...
	0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xf1, 0x02, 0x0a, 0x10,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x63, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x63, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69,
	0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1c,
	...
	,
	...
	0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74,
	0x22, 0x6c, 0x0a, 0x0e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x56, 0x31, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x62,
	0x61, 0x73, 0x69, 0x63, 0x41, 0x75, 0x74, 0x68, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x62, 0x61, 0x73, 0x69, 0x63, 0x41, 0x75, 0x74, 0x68, 0x1a, 0x39, 0x0a, 0x0b, 0x4c, 0x61, 0x62,
	...
	,
	...
	0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67,
	0x79, 0x49, 0x74, 0x65, 0x6d, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72,
	0x61, 0x74, 0x65, 0x67, 0x79, 0x49, 0x74, 0x65, 0x6d, 0x2e, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x61, 0x6e, 0x6e, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x37, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x44, 0x61, 0x74, 0x61, 0x73, 0x6f,
	...
	,
	...
	0x65, 0x6d, 0x61, 0x72, 0x6b, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x19, 0x0a, 0x03, 0x66, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x02, 0x52, 0x03, 0x66, 0x6f, 0x72,
	0x1a, 0x39, 0x0a, 0x0b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x3e, 0x0a, 0x10, 0x41,
	...
	,
...
var file_model_proto_goTypes = []interface{}{
	(NotifyTemplateType)(0),            // 0: api.NotifyTemplateType
	(*AlarmHistoryV1)(nil),             // 1: api.AlarmHistoryV1
	(*DictV1)(nil),                     // 2: api.DictV1
	(*DictSelectV1)(nil),               // 3: api.DictSelectV1
	(*PromStrategyV1)(nil),             // 4: api.PromStrategyV1
	(*PromStrategySelectV1)(nil),       // 5: api.PromStrategySelectV1
	(*PromGroup)(nil),                  // 6: api.PromGroup
	(*PromGroupSelectV1)(nil),          // 7: api.PromGroupSelectV1
	(*AlarmData)(nil),                  // 8: api.AlarmData
	(*Alert)(nil),                      // 9: api.Alert
	(*PrometheusServerItem)(nil),       // 10: api.PrometheusServerItem
	(*PrometheusServerSelectItem)(nil), // 11: api.PrometheusServerSelectItem
	(*ChatGroup)(nil),                  // 12: api.ChatGroup
	(*ChatGroupSelectV1)(nil),          // 13: api.ChatGroupSelectV1
	(*BeNotifyMember)(nil),             // 14: api.BeNotifyMember
	(*BeNotifyMemberDetail)(nil),       // 15: api.BeNotifyMemberDetail
	(*NotifyV1)(nil),                   // 16: api.NotifyV1
	(*ExternalNotifyObj)(nil),          // 17: api.ExternalNotifyObj
	(*ExternalCustomer)(nil),           // 18: api.ExternalCustomer
	(*ExternalCustomerHook)(nil),       // 19: api.ExternalCustomerHook
	(*NotifySelectV1)(nil),             // 20: api.NotifySelectV1
	(*InterveneInfo)(nil),              // 21: api.InterveneInfo
	(*AlarmUpgradeInfo)(nil),           // 22: api.AlarmUpgradeInfo
	(*AlarmSuppressInfo)(nil),          // 23: api.AlarmSuppressInfo
	(*RealtimeAlarmData)(nil),          // 24: api.RealtimeAlarmData
	(*Duration)(nil),                   // 25: api.Duration
	(*GroupSimple)(nil),                // 26: api.GroupSimple
	(*StrategySimple)(nil),             // 27: api.StrategySimple
	(*StrategyDatasource)(nil),         // 28: api.StrategyDatasource
	(*EvaluateStrategyItem)(nil),       // 29: api.EvaluateStrategyItem
	(*EvaluateGroup)(nil),              // 30: api.EvaluateGroup
	(*MyChart)(nil),                    // 31: api.MyChart
	(*MyDashboardConfig)(nil),          // 32: api.MyDashboardConfig
	(*MyDashboardConfigOption)(nil),    // 33: api.MyDashboardConfigOption
	(*PromRule)(nil),                   // 34: api.PromRule
	(*PromRuleGroup)(nil),              // 35: api.PromRuleGroup
	(*NotifyTemplateItem)(nil),         // 36: api.NotifyTemplateItem
	nil,                                // 37: api.AlarmHistoryV1.LabelsEntry
	nil,                                // 38: api.AlarmHistoryV1.AnnotationsEntry
	nil,                                // 39: api.PromStrategyV1.LabelsEntry
	nil,                                // 40: api.PromStrategyV1.AnnotationsEntry
	nil,                                // 41: api.AlarmData.GroupLabelsEntry
	nil,                                // 42: api.AlarmData.CommonLabelsEntry
	nil,                                // 43: api.AlarmData.CommonAnnotationsEntry
	nil,                                // 44: api.Alert.LabelsEntry
	nil,                                // 45: api.Alert.AnnotationsEntry
	nil,                                // 46: api.StrategySimple.LabelsEntry
	nil,                                // 47: api.StrategySimple.AnnotationsEntry
	nil,                                // 48: api.EvaluateStrategyItem.LabelsEntry
	nil,                                // 49: api.EvaluateStrategyItem.AnnotationsEntry
	nil,                                // 50: api.PromRule.LabelsEntry
	nil,                                // 51: api.PromRule.AnnotationsEntry
	(Category)(0),                      // 52: api.Category
	(Status)(0),                        // 53: api.Status
	(*UserSelectV1)(nil),               // 54: api.UserSelectV1
	(NotifyType)(0),                    // 55: api.NotifyType
	(ChartType)(0),                     // 56: api.ChartType
}
var file_model_proto_depIdxs = []int32{
	3,  // 0: api.AlarmHistoryV1.alarmLevel:type_name -> api.DictSelectV1
	37, // 1: api.AlarmHistoryV1.labels:type_name -> api.AlarmHistoryV1.LabelsEntry
	38, // 2: api.AlarmHistoryV1.annotations:type_name -> api.AlarmHistoryV1.AnnotationsEntry
	52, // 3: api.DictSelectV1.category:type_name -> api.Category
	53, // 4: api.DictSelectV1.status:type_name -> api.Status
	25, // 5: api.PromStrategyV1.duration:type_name -> api.Duration
	39, // 6: api.PromStrategyV1.labels:type_name -> api.PromStrategyV1.LabelsEntry
	40, // 7: api.PromStrategyV1.annotations:type_name -> api.PromStrategyV1.AnnotationsEntry
	7,  // 8: api.PromStrategyV1.groupInfo:type_name -> api.PromGroupSelectV1
	3,  // 9: api.PromStrategyV1.alarmLevelInfo:type_name -> api.DictSelectV1
	3,  // 10: api.PromStrategyV1.alarmPageInfo:type_name -> api.DictSelectV1
	3,  // 11: api.PromStrategyV1.categoryInfo:type_name -> api.DictSelectV1
	11, // 12: api.PromStrategyV1.dataSource:type_name -> api.PrometheusServerSelectItem
	25, // 13: api.PromStrategyV1.maxSuppress:type_name -> api.Duration
	25, // 14: api.PromStrategyV1.sendInterval:type_name -> api.Duration
	3,  // 15: api.PromStrategySelectV1.category:type_name -> api.DictSelectV1
	3,  // 16: api.PromGroup.categories:type_name -> api.DictSelectV1
	4,  // 17: api.PromGroup.strategies:type_name -> api.PromStrategyV1
	3,  // 18: api.PromGroupSelectV1.category:type_name -> api.DictSelectV1
	9,  // 19: api.AlarmData.alerts:type_name -> api.Alert
	41, // 20: api.AlarmData.groupLabels:type_name -> api.AlarmData.GroupLabelsEntry
	42, // 21: api.AlarmData.commonLabels:type_name -> api.AlarmData.CommonLabelsEntry
	43, // 22: api.AlarmData.commonAnnotations:type_name -> api.AlarmData.CommonAnnotationsEntry
	44, // 23: api.Alert.labels:type_name -> api.Alert.LabelsEntry
	45, // 24: api.Alert.annotations:type_name -> api.Alert.AnnotationsEntry
	54, // 25: api.ChatGroup.createUser:type_name -> api.UserSelectV1
	55, // 26: api.BeNotifyMember.notifyType:type_name -> api.NotifyType
	54, // 27: api.BeNotifyMemberDetail.user:type_name -> api.UserSelectV1
	15, // 28: api.NotifyV1.members:type_name -> api.BeNotifyMemberDetail
	13, // 29: api.NotifyV1.chatGroups:type_name -> api.ChatGroupSelectV1
	17, // 30: api.NotifyV1.externalNotifyObjs:type_name -> api.ExternalNotifyObj
	18, // 31: api.ExternalNotifyObj.externalCustomerList:type_name -> api.ExternalCustomer
	19, // 32: api.ExternalNotifyObj.externalCustomerHookList:type_name -> api.ExternalCustomerHook
	19, // 33: api.ExternalCustomer.externalCustomerHookList:type_name -> api.ExternalCustomerHook
	54, // 34: api.InterveneInfo.intervenedUser:type_name -> api.UserSelectV1
	54, // 35: api.AlarmUpgradeInfo.upgradedUser:type_name -> api.UserSelectV1
	54, // 36: api.AlarmSuppressInfo.suppressedUser:type_name -> api.UserSelectV1
	21, // 37: api.RealtimeAlarmData.intervenedUser:type_name -> api.InterveneInfo
	15, // 38: api.RealtimeAlarmData.beenNotifyMembers:type_name -> api.BeNotifyMemberDetail
	22, // 39: api.RealtimeAlarmData.upgradedUser:type_name -> api.AlarmUpgradeInfo
	23, // 40: api.RealtimeAlarmData.suppressedUser:type_name -> api.AlarmSuppressInfo
	13, // 41: api.RealtimeAlarmData.notifiedChatGroups:type_name -> api.ChatGroupSelectV1
	3,  // 42: api.RealtimeAlarmData.level:type_name -> api.DictSelectV1
	4,  // 43: api.RealtimeAlarmData.strategy:type_name -> api.PromStrategyV1
	27, // 44: api.GroupSimple.strategies:type_name -> api.StrategySimple
	25, // 45: api.StrategySimple.duration:type_name -> api.Duration
	46, // 46: api.StrategySimple.labels:type_name -> api.StrategySimple.LabelsEntry
	47, // 47: api.StrategySimple.annotations:type_name -> api.StrategySimple.AnnotationsEntry
	25, // 48: api.EvaluateStrategyItem.duration:type_name -> api.Duration
	48, // 49: api.EvaluateStrategyItem.labels:type_name -> api.EvaluateStrategyItem.LabelsEntry
	49, // 50: api.EvaluateStrategyItem.annotations:type_name -> api.EvaluateStrategyItem.AnnotationsEntry
	28, // 51: api.EvaluateStrategyItem.datasource:type_name -> api.StrategyDatasource
	29, // 52: api.EvaluateGroup.strategies:type_name -> api.EvaluateStrategyItem
	56, // 53: api.MyChart.chartType:type_name -> api.ChartType
	31, // 54: api.MyDashboardConfig.charts:type_name -> api.MyChart
	50, // 55: api.PromRule.labels:type_name -> api.PromRule.LabelsEntry
	51, // 56: api.PromRule.annotations:type_name -> api.PromRule.AnnotationsEntry
	34, // 57: api.PromRuleGroup.rules:type_name -> api.PromRule
...
func file_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StrategyDatasource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EvaluateStrategyItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NotifyTemplateItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
