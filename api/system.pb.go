...
var file_system_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x2a, 0x95,
	...
	0x65, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x4f, 0x74, 0x68, 0x65, 0x72, 0x10, 0x0d, 0x42, 0x23, 0x0a,
...
var file_system_proto_goTypes = []interface{}{
	...
	(*ApiTree)(nil),      // 9: api.ApiTree
	(*Module)(nil),       // 10: api.Module
}
var file_system_proto_depIdxs = []int32{
	...
	10, // 4: api.ApiTree.module:type_name -> api.Module
	2,  // 5: api.Module.module:type_name -> api.ModuleType
	8,  // 6: api.Module.apis:type_name -> api.ApiSelectV1
